...
meta:
	ADDON_NAME = ofxFixtures
	ADDON_DESCRIPTION = addon for DMX fixtures control
	ADDON_AUTHOR = @npisanti
	ADDON_TAGS = "addon" "dmx" "fixture" "head" "DMX" "hardware"
	ADDON_URL = http://github.com/npisanti/ofxFixtures
